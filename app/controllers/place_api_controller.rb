class PlaceApiController < ApplicationController
  def show
    ...
    request = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=" + params[:input] + "&types=establishment&location=34.68291,134.87708&language=ja&radius=1000000&strictbounds&key=AIzaSyA98KOQTpTOsj3o8YQG6_lDJsBgYwhjPbI"
